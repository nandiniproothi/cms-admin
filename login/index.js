...
function googleSignIn() {
    ...
    firebase.auth().signInWithPopup(provider).then(function (result) {
        ...
        if(user.email.equals("nandiniproothi@gmail.com") || user.email.equals("dimpleluvspeace@gmail.com")){ //crap, now you know my email. anyway, only i'm allowed to login :D
